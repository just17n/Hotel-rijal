                    ...
                    <div class="card-body">
                        <form class="row g-3" method="post">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="username" name="username" autocomplete="off" value="<?= $ekstrak['username']; ?>" disabled>
                            </div>
                            <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Password</label>
                                <input type="text" class="form-control" id="password" name="password" autocomplete="off" value="<?= $ekstrak['password']; ?>" disabled>
                            </div>
                            <div class="col-12">
