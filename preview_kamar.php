                    ...
                    <div class="card-body">
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                ...
                                <select class="form-select" aria-label="Pilih Tipe Kamar" name="tipe_kamar" disabled>
                            ...
                            <div class="col-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="harga" name="harga" readonly="true" autocomplete="off" aria-describedby="basic-addon3" value="<?= $ekstrak['harga']; ?>">
                                </div>
                            </div>
                            <div class="col-4">
